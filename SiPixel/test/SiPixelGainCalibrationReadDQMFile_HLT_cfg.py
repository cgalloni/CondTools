...
process.GlobalTag.globaltag = "GR_R_71_V5::All"
process.GlobalTag.globaltag = "GR_R_71_V5::All"

process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string('/tmp/cgalloni/Summary_payload_Run209685_HLT.root')
                                   )
process.readfileOffline = cms.EDAnalyzer("SiPixelGainCalibrationReadDQMFile",
#    supportedProtocols = cms.vstring('rfio'),
    inputrootfile = cms.untracked.string('/tmp/cgalloni/GainCalibration_209685.root'),
...
#        ),
    ...
    connect = cms.string('sqlite_file:/tmp/cgalloni/prova_GainRun209685_31X_HLT.db')
...
process.p = cms.Path(process.readfileHLT)
